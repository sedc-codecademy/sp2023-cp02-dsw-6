...
function displayDesc(book) {
  if (book) {
    ...
    coverImg.innerHTML = `<img src="${book.volumeInfo.imageLinks.thumbnail}" width="70%" height="100%" alt="Cover Image">`;
    categoriesSpan.innerHTML += book.volumeInfo.categories;
